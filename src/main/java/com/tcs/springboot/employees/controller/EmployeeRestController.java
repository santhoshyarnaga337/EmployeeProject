...
import com.tcs.springboot.employees.service.EmployeeService;
...
public class EmployeeRestController {
	...
	@Operation(summary = "Search employees by last name", description = "Fetch employees using custom query by last name.")
	@ResponseStatus(HttpStatus.OK)
